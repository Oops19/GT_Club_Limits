...
# Make sure to have only one 'modinfo.py' in your project directory. The first found 'modinfo.py' is used and zone_loaded.
#
#
...
Unpyc3PythonCompiler.compile_mod(
    ...
    output_ts4script_name=f"{author}_{mod_name}"  # mod_directory
)
